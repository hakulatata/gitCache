...
public class IosBottomDialog extends Dialog {
    ...
    public static final int DEFAULT_OPTION_SIZE = 16;
    ...
    private void initView() {
        ...
        findViewById(R.id.bottom_dialog_cancel_tv).setOnClickListener(v -> IosBottomDialog.this.dismiss());
        //点击空白区域可以取消dialog
        ...
        public IosBottomDialog create() {
            ...
            if (p.options.size() == 0) {
                ...
                for (int i = 0; i < p.options.size(); i++) {
                    ...
                    int padding = dp2px(IosBottomDialog.DEFAULT_PADDING);
                    ...
                    if (i != p.options.size() - 1) {
                        ...
                        divider.setBackgroundResource(R.color.thirdly_text);
